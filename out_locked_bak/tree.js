...
class StockTreeItem extends vscode.TreeItem {
    ...
    constructor(quote, kind, pinned = false) {
        ...
        this.description = `${maskNum((0, fetcher_1.fmtPrice)(quote.price))}  ${maskNum(sign + (0, fetcher_1.fmtPrice)(quote.change))}  ${maskNum(sign + quote.changePct.toFixed(2) + '%')}${pinned && !bossMode ? '  📌' : ''}`;
